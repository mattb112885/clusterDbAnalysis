...
as inputs and identifies all of the genes between the start and stop columns (the entire 
...
parser.add_option("-s", "--startcol", help="Column number for the start fo the region to search, starting from 1 (D=5)",
...
for line in fileinput.input("-"):
    ...
    geneids = getGenesInRegion(contig, start, stop, cur)
