...
usage = "tblastn_all_vs_all.py [Faa_folder] [Contig_folder] [Output_folder] [ncores]"
...
parser.add_option("-t", "--threshold", help="E-value threshold (D=1E-5)", action="store", type="float", dest="threshold", default=1E-5)
...
def runTblast(genpath, protpath, outpath, evalue):
    ...
    #
    cline = "tblastn -query %s -db %s -out %s -outfmt 6 -evalue %1.4f -db_gencode 11" %(protpath, genpath, outpath, ealue)
